...
Void Stage_obj::__onKey( ::String type,int keyCode,int modifier){
{
		...
		if ((tmp10)){
			...
			HX_STACK_LINE(1330)
			bool tmp35 = (keyCode1 == (int)13);		HX_STACK_VAR(tmp35,"tmp35");
			HX_STACK_LINE(1330)
			...
			if ((tmp36)){
				...
				HX_STACK_LINE(1330)
				tmp37 = ::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(tmp40);
			}
			else{
				HX_STACK_LINE(1330)
				tmp37 = false;
			...
			if ((tmp38)){
				HX_STACK_LINE(1330)
				::String tmp40 = type;		HX_STACK_VAR(tmp40,"tmp40");
				HX_STACK_LINE(1330)
				::String tmp41 = ::openfl::events::KeyboardEvent_obj::KEY_DOWN;		HX_STACK_VAR(tmp41,"tmp41");
				HX_STACK_LINE(1330)
			...
			if ((tmp40)){
				...
				HX_STACK_LINE(1330)
				bool tmp45 = ::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(tmp44);		HX_STACK_VAR(tmp45,"tmp45");
				HX_STACK_LINE(1330)
			...
			if ((tmp42)){
				...
				HX_STACK_LINE(1330)
				bool tmp47 = ::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_shiftKey(tmp46);		HX_STACK_VAR(tmp47,"tmp47");
				HX_STACK_LINE(1330)
				bool tmp48 = tmp47;		HX_STACK_VAR(tmp48,"tmp48");
				HX_STACK_LINE(1330)
				bool tmp49 = tmp48;		HX_STACK_VAR(tmp49,"tmp49");
			...
			if ((tmp44)){
				...
				HX_STACK_LINE(1330)
				bool tmp49 = ::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_metaKey(tmp48);		HX_STACK_VAR(tmp49,"tmp49");
				HX_STACK_LINE(1330)
				bool tmp50 = tmp49;		HX_STACK_VAR(tmp50,"tmp50");
				HX_STACK_LINE(1330)
				bool tmp51 = tmp50;		HX_STACK_VAR(tmp51,"tmp51");
