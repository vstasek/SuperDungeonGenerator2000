...
{
HX_STACK_FRAME("openfl._internal.renderer.opengl.utils._SpriteBatch.State","new",0xda8a05cc,"openfl._internal.renderer.opengl.utils._SpriteBatch.State.new","openfl/_internal/renderer/opengl/utils/SpriteBatch.hx",662,0x8289eb2d)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(667)
...
bool State_obj::equals( ::openfl::_internal::renderer::opengl::utils::_SpriteBatch::State other){
	HX_STACK_FRAME("openfl._internal.renderer.opengl.utils._SpriteBatch.State","equals",0xfb2ee453,"openfl._internal.renderer.opengl.utils._SpriteBatch.State.equals","openfl/_internal/renderer/opengl/utils/SpriteBatch.hx",673,0x8289eb2d)
	HX_STACK_THIS(this)
	...
	if ((tmp11)){
		HX_STACK_LINE(679)
		::openfl::display::BlendMode tmp13 = this->blendMode;		HX_STACK_VAR(tmp13,"tmp13");
		HX_STACK_LINE(679)
		::openfl::display::BlendMode tmp14 = tmp13;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(679)
		::openfl::display::BlendMode tmp15 = tmp14;		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(679)
		::openfl::display::BlendMode tmp16 = other->blendMode;		HX_STACK_VAR(tmp16,"tmp16");
		HX_STACK_LINE(679)
		tmp12 = (tmp15 == tmp16);
	}
	else{
	...
	if ((tmp12)){
		HX_STACK_LINE(681)
		::openfl::geom::ColorTransform tmp14 = this->colorTransform;		HX_STACK_VAR(tmp14,"tmp14");
		HX_STACK_LINE(681)
		::openfl::geom::ColorTransform tmp15 = tmp14;		HX_STACK_VAR(tmp15,"tmp15");
		HX_STACK_LINE(681)
		...
		if ((tmp20)){
			HX_STACK_LINE(681)
			bool tmp21 = (other->colorTransform == null());		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(681)
			tmp19 = tmp21;
		}
		else{
		...
		if ((tmp24)){
			HX_STACK_LINE(681)
			::openfl::geom::ColorTransform tmp25 = this->colorTransform;		HX_STACK_VAR(tmp25,"tmp25");
			HX_STACK_LINE(681)
			::openfl::geom::ColorTransform tmp26 = tmp25;		HX_STACK_VAR(tmp26,"tmp26");
			HX_STACK_LINE(681)
			::openfl::geom::ColorTransform tmp27 = tmp26;		HX_STACK_VAR(tmp27,"tmp27");
			HX_STACK_LINE(681)
			...
			if ((tmp34)){
				HX_STACK_LINE(681)
				bool tmp35 = (other->colorTransform != null());		HX_STACK_VAR(tmp35,"tmp35");
				HX_STACK_LINE(681)
			...
			if ((tmp36)){
				HX_STACK_LINE(681)
				::openfl::geom::ColorTransform tmp37 = this->colorTransform;		HX_STACK_VAR(tmp37,"tmp37");
				HX_STACK_LINE(681)
				::openfl::geom::ColorTransform tmp38 = tmp37;		HX_STACK_VAR(tmp38,"tmp38");
				HX_STACK_LINE(681)
				...
				HX_STACK_LINE(681)
				::openfl::geom::ColorTransform tmp41 = other->colorTransform;		HX_STACK_VAR(tmp41,"tmp41");
				HX_STACK_LINE(681)
				bool tmp42 = this->skipColorTransformAlpha;		HX_STACK_VAR(tmp42,"tmp42");
				HX_STACK_LINE(681)
				...
				HX_STACK_LINE(681)
				::openfl::geom::ColorTransform tmp46 = tmp41;		HX_STACK_VAR(tmp46,"tmp46");
				HX_STACK_LINE(681)
				bool tmp47 = tmp45;		HX_STACK_VAR(tmp47,"tmp47");
				HX_STACK_LINE(681)
				::openfl::geom::ColorTransform tmp48 = tmp46;		HX_STACK_VAR(tmp48,"tmp48");
				HX_STACK_LINE(681)
				bool tmp49 = tmp47;		HX_STACK_VAR(tmp49,"tmp49");
				HX_STACK_LINE(681)
				::openfl::geom::ColorTransform tmp50 = tmp48;		HX_STACK_VAR(tmp50,"tmp50");
				HX_STACK_LINE(681)
				bool tmp51 = tmp49;		HX_STACK_VAR(tmp51,"tmp51");
				HX_STACK_LINE(681)
				tmp13 = tmp40->__equals(tmp50,tmp51);
			}
			else{
				HX_STACK_LINE(681)
				tmp13 = false;
...
{
		HX_STACK_FRAME("openfl._internal.renderer.opengl.utils._SpriteBatch.State","destroy",0xbdc18866,"openfl._internal.renderer.opengl.utils._SpriteBatch.State.destroy","openfl/_internal/renderer/opengl/utils/SpriteBatch.hx",685,0x8289eb2d)
		HX_STACK_THIS(this)
		HX_STACK_LINE(686)
		this->texture = null();
		HX_STACK_LINE(687)
