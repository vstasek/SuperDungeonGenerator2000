...
::openfl::_internal::renderer::DrawCommandReader OverrideMatrixView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.OverrideMatrixView_Impl_","_new",0x139046f5,"openfl._internal.renderer._DrawCommandReader.OverrideMatrixView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",452,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(452)
...
::openfl::geom::Matrix OverrideMatrixView_Impl__obj::get_matrix( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.OverrideMatrixView_Impl_","get_matrix",0x91a43e9e,"openfl._internal.renderer._DrawCommandReader.OverrideMatrixView_Impl_.get_matrix","openfl/_internal/renderer/DrawCommandReader.hx",453,0xbbdbd1ae)
