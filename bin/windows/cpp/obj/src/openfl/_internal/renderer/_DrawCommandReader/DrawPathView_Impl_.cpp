...
::openfl::_internal::renderer::DrawCommandReader DrawPathView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawPathView_Impl_","_new",0x6624da59,"openfl._internal.renderer._DrawCommandReader.DrawPathView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",326,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(326)
...
Array< int > DrawPathView_Impl__obj::get_commands( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawPathView_Impl_","get_commands",0xd5b6e1c9,"openfl._internal.renderer._DrawCommandReader.DrawPathView_Impl_.get_commands","openfl/_internal/renderer/DrawCommandReader.hx",327,0xbbdbd1ae)
...
Array< Float > DrawPathView_Impl__obj::get_data( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawPathView_Impl_","get_data",0xa4b5b2ab,"openfl._internal.renderer._DrawCommandReader.DrawPathView_Impl_.get_data","openfl/_internal/renderer/DrawCommandReader.hx",328,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(328)
...
::openfl::display::GraphicsPathWinding DrawPathView_Impl__obj::get_winding( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawPathView_Impl_","get_winding",0x6a43f339,"openfl._internal.renderer._DrawCommandReader.DrawPathView_Impl_.get_winding","openfl/_internal/renderer/DrawCommandReader.hx",329,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(329)
