...
::openfl::_internal::renderer::DrawCommandReader CubicCurveToView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_","_new",0x4a8bb022,"openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",281,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(281)
...
Float CubicCurveToView_Impl__obj::get_controlX1( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_","get_controlX1",0x39f1626c,"openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_.get_controlX1","openfl/_internal/renderer/DrawCommandReader.hx",282,0xbbdbd1ae)
...
Float CubicCurveToView_Impl__obj::get_controlY1( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_","get_controlY1",0x39f1634b,"openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_.get_controlY1","openfl/_internal/renderer/DrawCommandReader.hx",283,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(283)
...
Float CubicCurveToView_Impl__obj::get_controlX2( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_","get_controlX2",0x39f1626d,"openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_.get_controlX2","openfl/_internal/renderer/DrawCommandReader.hx",284,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(284)
...
Float CubicCurveToView_Impl__obj::get_controlY2( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_","get_controlY2",0x39f1634c,"openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_.get_controlY2","openfl/_internal/renderer/DrawCommandReader.hx",285,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(285)
...
Float CubicCurveToView_Impl__obj::get_anchorX( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_","get_anchorX",0x7a5efbb9,"openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_.get_anchorX","openfl/_internal/renderer/DrawCommandReader.hx",286,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(286)
...
Float CubicCurveToView_Impl__obj::get_anchorY( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_","get_anchorY",0x7a5efbba,"openfl._internal.renderer._DrawCommandReader.CubicCurveToView_Impl_.get_anchorY","openfl/_internal/renderer/DrawCommandReader.hx",287,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(287)
	int tmp = (this1->fPos + (int)6);		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(287)
	Float tmp1 = this1->buffer->f->__get(tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(287)
	return tmp1;
