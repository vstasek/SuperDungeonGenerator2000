...
::openfl::_internal::renderer::DrawCommandReader DrawTilesView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","_new",0x5728ce51,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",360,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(360)
...
::openfl::display::Tilesheet DrawTilesView_Impl__obj::get_sheet( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_sheet",0x872b2006,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_sheet","openfl/_internal/renderer/DrawCommandReader.hx",361,0xbbdbd1ae)
...
Array< Float > DrawTilesView_Impl__obj::get_tileData( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_tileData",0x40575971,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_tileData","openfl/_internal/renderer/DrawCommandReader.hx",362,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(362)
...
bool DrawTilesView_Impl__obj::get_smooth( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_smooth",0xa63584e7,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_smooth","openfl/_internal/renderer/DrawCommandReader.hx",363,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(363)
...
int DrawTilesView_Impl__obj::get_flags( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_flags",0x0d9768ae,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_flags","openfl/_internal/renderer/DrawCommandReader.hx",364,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(364)
...
::openfl::display::Shader DrawTilesView_Impl__obj::get_shader( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_shader",0xbbeb3bde,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_shader","openfl/_internal/renderer/DrawCommandReader.hx",365,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(365)
	...
	HX_STACK_LINE(365)
	::openfl::display::Shader tmp2 = ((::openfl::display::Shader)(tmp1));		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(365)
	return tmp2;
}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(DrawTilesView_Impl__obj,get_shader,return )

int DrawTilesView_Impl__obj::get_count( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_","get_count",0x556e8236,"openfl._internal.renderer._DrawCommandReader.DrawTilesView_Impl_.get_count","openfl/_internal/renderer/DrawCommandReader.hx",366,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(366)
