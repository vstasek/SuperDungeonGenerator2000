...
::openfl::_internal::renderer::DrawCommandReader BeginFillView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_","_new",0xff2dc446,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",257,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(257)
...
int BeginFillView_Impl__obj::get_color( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_","get_color",0x83ba00b5,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_.get_color","openfl/_internal/renderer/DrawCommandReader.hx",258,0xbbdbd1ae)
...
Float BeginFillView_Impl__obj::get_alpha( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_","get_alpha",0x5af436b0,"openfl._internal.renderer._DrawCommandReader.BeginFillView_Impl_.get_alpha","openfl/_internal/renderer/DrawCommandReader.hx",259,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(259)
