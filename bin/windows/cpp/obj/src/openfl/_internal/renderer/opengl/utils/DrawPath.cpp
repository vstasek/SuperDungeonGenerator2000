...
::openfl::_internal::renderer::opengl::utils::GLStack DrawPath_obj::getStack( ::openfl::display::Graphics graphics,::lime::graphics::GLRenderContext gl){
	HX_STACK_FRAME("openfl._internal.renderer.opengl.utils.DrawPath","getStack",0xb03e6216,"openfl._internal.renderer.opengl.utils.DrawPath.getStack","openfl/_internal/renderer/opengl/utils/DrawPath.hx",66,0xf0fd7951)
