...
::openfl::_internal::renderer::DrawCommandReader CurveToView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","_new",0x02b6a548,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",294,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(294)
...
Float CurveToView_Impl__obj::get_controlX( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_controlX",0xd0ea894b,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_controlX","openfl/_internal/renderer/DrawCommandReader.hx",295,0xbbdbd1ae)
...
Float CurveToView_Impl__obj::get_controlY( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_controlY",0xd0ea894c,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_controlY","openfl/_internal/renderer/DrawCommandReader.hx",296,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(296)
...
Float CurveToView_Impl__obj::get_anchorX( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_anchorX",0x40299753,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_anchorX","openfl/_internal/renderer/DrawCommandReader.hx",297,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(297)
...
Float CurveToView_Impl__obj::get_anchorY( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_","get_anchorY",0x40299754,"openfl._internal.renderer._DrawCommandReader.CurveToView_Impl_.get_anchorY","openfl/_internal/renderer/DrawCommandReader.hx",298,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(298)
