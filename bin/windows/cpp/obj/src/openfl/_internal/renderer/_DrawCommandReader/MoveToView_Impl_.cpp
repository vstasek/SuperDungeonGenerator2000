...
::openfl::_internal::renderer::DrawCommandReader MoveToView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","_new",0x9bdb8896,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",443,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(443)
...
Float MoveToView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","get_x",0x5989007a,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",444,0xbbdbd1ae)
...
Float MoveToView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_","get_y",0x5989007b,"openfl._internal.renderer._DrawCommandReader.MoveToView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",445,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(445)
