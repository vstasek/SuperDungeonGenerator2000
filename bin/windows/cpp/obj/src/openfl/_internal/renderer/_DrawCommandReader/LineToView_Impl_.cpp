...
::openfl::_internal::renderer::DrawCommandReader LineToView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.LineToView_Impl_","_new",0xdb6ba453,"openfl._internal.renderer._DrawCommandReader.LineToView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",434,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(434)
...
Float LineToView_Impl__obj::get_x( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.LineToView_Impl_","get_x",0xb8112a1d,"openfl._internal.renderer._DrawCommandReader.LineToView_Impl_.get_x","openfl/_internal/renderer/DrawCommandReader.hx",435,0xbbdbd1ae)
...
Float LineToView_Impl__obj::get_y( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.LineToView_Impl_","get_y",0xb8112a1e,"openfl._internal.renderer._DrawCommandReader.LineToView_Impl_.get_y","openfl/_internal/renderer/DrawCommandReader.hx",436,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(436)
