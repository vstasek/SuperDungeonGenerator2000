...
::openfl::_internal::renderer::DrawCommandReader LineBitmapStyleView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","_new",0x6ec636a4,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",393,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(393)
...
::openfl::display::BitmapData LineBitmapStyleView_Impl__obj::get_bitmap( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_bitmap",0xeee7753b,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_bitmap","openfl/_internal/renderer/DrawCommandReader.hx",394,0xbbdbd1ae)
...
::openfl::geom::Matrix LineBitmapStyleView_Impl__obj::get_matrix( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_matrix",0xb9a39b8d,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_matrix","openfl/_internal/renderer/DrawCommandReader.hx",395,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(395)
...
bool LineBitmapStyleView_Impl__obj::get_repeat( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_repeat",0x0457fca7,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_repeat","openfl/_internal/renderer/DrawCommandReader.hx",396,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(396)
...
bool LineBitmapStyleView_Impl__obj::get_smooth( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_","get_smooth",0x05466d7a,"openfl._internal.renderer._DrawCommandReader.LineBitmapStyleView_Impl_.get_smooth","openfl/_internal/renderer/DrawCommandReader.hx",397,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(397)
