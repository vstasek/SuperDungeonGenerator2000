...
::openfl::_internal::renderer::DrawCommandReader BeginBitmapFillView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","_new",0x824c6ed7,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",246,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(246)
...
::openfl::display::BitmapData BeginBitmapFillView_Impl__obj::get_bitmap( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_bitmap",0x65ae55ae,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_bitmap","openfl/_internal/renderer/DrawCommandReader.hx",247,0xbbdbd1ae)
...
::openfl::geom::Matrix BeginBitmapFillView_Impl__obj::get_matrix( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_matrix",0x306a7c00,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_matrix","openfl/_internal/renderer/DrawCommandReader.hx",248,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(248)
...
bool BeginBitmapFillView_Impl__obj::get_repeat( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_repeat",0x7b1edd1a,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_repeat","openfl/_internal/renderer/DrawCommandReader.hx",249,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(249)
...
bool BeginBitmapFillView_Impl__obj::get_smooth( ::openfl::_internal::renderer::DrawCommandReader this1){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_","get_smooth",0x7c0d4ded,"openfl._internal.renderer._DrawCommandReader.BeginBitmapFillView_Impl_.get_smooth","openfl/_internal/renderer/DrawCommandReader.hx",250,0xbbdbd1ae)
	HX_STACK_ARG(this1,"this1")
	HX_STACK_LINE(250)
