				...
				while((true)){
					...
					switch( (int)(type->__Index())){
						case (int)3: {
							...
							HX_STACK_LINE(1210)
							int tmp53 = (tmp52 + (int)6);		HX_STACK_VAR(tmp53,"tmp53");
							HX_STACK_LINE(1210)
							...
							HX_STACK_LINE(1211)
							int tmp66 = (tmp65 + (int)3);		HX_STACK_VAR(tmp66,"tmp66");
							HX_STACK_LINE(1211)
							...
							HX_STACK_LINE(1211)
							int tmp74 = (tmp73 + (int)5);		HX_STACK_VAR(tmp74,"tmp74");
							HX_STACK_LINE(1211)
							...
							HX_STACK_LINE(1211)
							int tmp78 = (tmp77 + (int)6);		HX_STACK_VAR(tmp78,"tmp78");
							HX_STACK_LINE(1211)
						...
						case (int)15: {
							...
							Dynamic tmp54 = tmp51->o->__GetItem(tmp53);		HX_STACK_VAR(tmp54,"tmp54");
							HX_STACK_LINE(1252)
							::openfl::display::LineScaleMode tmp55 = ((::openfl::display::LineScaleMode)(tmp54));		HX_STACK_VAR(tmp55,"tmp55");
							HX_STACK_LINE(1252)
							::openfl::_internal::renderer::DrawCommandBuffer tmp56 = c->buffer;		HX_STACK_VAR(tmp56,"tmp56");
							HX_STACK_LINE(1252)
							int tmp57 = c->oPos;		HX_STACK_VAR(tmp57,"tmp57");
							HX_STACK_LINE(1252)
							int tmp58 = (tmp57 + (int)5);		HX_STACK_VAR(tmp58,"tmp58");
							HX_STACK_LINE(1252)
							Dynamic tmp59 = tmp56->o->__GetItem(tmp58);		HX_STACK_VAR(tmp59,"tmp59");
							HX_STACK_LINE(1252)
							::openfl::display::CapsStyle tmp60 = ((::openfl::display::CapsStyle)(tmp59));		HX_STACK_VAR(tmp60,"tmp60");
							HX_STACK_LINE(1252)
							...
							HX_STACK_LINE(1252)
							int tmp63 = (tmp62 + (int)6);		HX_STACK_VAR(tmp63,"tmp63");
							HX_STACK_LINE(1252)
							Dynamic tmp64 = tmp61->o->__GetItem(tmp63);		HX_STACK_VAR(tmp64,"tmp64");
							HX_STACK_LINE(1252)
							::openfl::display::JointStyle tmp65 = ((::openfl::display::JointStyle)(tmp64));		HX_STACK_VAR(tmp65,"tmp65");
							HX_STACK_LINE(1252)
							::openfl::_internal::renderer::DrawCommandBuffer tmp66 = c->buffer;		HX_STACK_VAR(tmp66,"tmp66");
							HX_STACK_LINE(1252)
							int tmp67 = c->oPos;		HX_STACK_VAR(tmp67,"tmp67");
							HX_STACK_LINE(1252)
							int tmp68 = (tmp67 + (int)7);		HX_STACK_VAR(tmp68,"tmp68");
							HX_STACK_LINE(1252)
							Dynamic tmp69 = tmp66->o->__GetItem(tmp68);		HX_STACK_VAR(tmp69,"tmp69");
							HX_STACK_LINE(1252)
						...
						case (int)0: case (int)1: case (int)2: {
							...
							if ((tmp29)){
								...
								if ((tmp30)){
									...
									Dynamic tmp36 = tmp33->o->__GetItem(tmp35);		HX_STACK_VAR(tmp36,"tmp36");
									HX_STACK_LINE(1268)
									::openfl::display::GradientType tmp37 = ((::openfl::display::GradientType)(tmp36));		HX_STACK_VAR(tmp37,"tmp37");
									HX_STACK_LINE(1268)
									::openfl::_internal::renderer::DrawCommandBuffer tmp38 = c->buffer;		HX_STACK_VAR(tmp38,"tmp38");
									HX_STACK_LINE(1268)
									...
									HX_STACK_LINE(1268)
									::openfl::display::SpreadMethod tmp56 = ((::openfl::display::SpreadMethod)(tmp55));		HX_STACK_VAR(tmp56,"tmp56");
									HX_STACK_LINE(1268)
									::openfl::_internal::renderer::DrawCommandBuffer tmp57 = c->buffer;		HX_STACK_VAR(tmp57,"tmp57");
									HX_STACK_LINE(1268)
									int tmp58 = c->oPos;		HX_STACK_VAR(tmp58,"tmp58");
									...
									Dynamic tmp60 = tmp57->o->__GetItem(tmp59);		HX_STACK_VAR(tmp60,"tmp60");
									HX_STACK_LINE(1268)
									::openfl::display::InterpolationMethod tmp61 = ((::openfl::display::InterpolationMethod)(tmp60));		HX_STACK_VAR(tmp61,"tmp61");
									HX_STACK_LINE(1268)
									::openfl::_internal::renderer::DrawCommandBuffer tmp62 = c->buffer;		HX_STACK_VAR(tmp62,"tmp62");
									HX_STACK_LINE(1268)
									...
									HX_STACK_LINE(1268)
									Dynamic tmp66 = tmp65;		HX_STACK_VAR(tmp66,"tmp66");
									HX_STACK_LINE(1268)
									...
									HX_STACK_LINE(1269)
									::openfl::display::GradientType tmp72 = ((::openfl::display::GradientType)(tmp71));		HX_STACK_VAR(tmp72,"tmp72");
									HX_STACK_LINE(1269)
									::openfl::_internal::renderer::DrawCommandBuffer tmp73 = c->buffer;		HX_STACK_VAR(tmp73,"tmp73");
									HX_STACK_LINE(1269)
									...
									HX_STACK_LINE(1269)
									::openfl::display::SpreadMethod tmp91 = ((::openfl::display::SpreadMethod)(tmp90));		HX_STACK_VAR(tmp91,"tmp91");
									HX_STACK_LINE(1269)
									...
									HX_STACK_LINE(1269)
									::openfl::display::InterpolationMethod tmp96 = ((::openfl::display::InterpolationMethod)(tmp95));		HX_STACK_VAR(tmp96,"tmp96");
									HX_STACK_LINE(1269)
									::openfl::_internal::renderer::DrawCommandBuffer tmp97 = c->buffer;		HX_STACK_VAR(tmp97,"tmp97");
									HX_STACK_LINE(1269)
									int tmp98 = c->oPos;		HX_STACK_VAR(tmp98,"tmp98");
									HX_STACK_LINE(1269)
									int tmp99 = (tmp98 + (int)4);		HX_STACK_VAR(tmp99,"tmp99");
									HX_STACK_LINE(1269)
									Dynamic tmp100 = tmp97->o->__GetItem(tmp99);		HX_STACK_VAR(tmp100,"tmp100");
									HX_STACK_LINE(1269)
									Dynamic tmp101 = tmp100;		HX_STACK_VAR(tmp101,"tmp101");
									HX_STACK_LINE(1269)
						...
						case (int)9: {
							...
							Float tmp54 = tmp51->f->__get(tmp53);		HX_STACK_VAR(tmp54,"tmp54");
							HX_STACK_LINE(1300)
							tmp30->drawRoundRect(tmp34,tmp38,tmp42,tmp46,tmp50,tmp54);
							HX_STACK_LINE(1301)
							::openfl::_internal::renderer::DrawCommandBuffer tmp55 = ::openfl::_internal::renderer::cairo::CairoGraphics_obj::strokeCommands;		HX_STACK_VAR(tmp55,"tmp55");
							HX_STACK_LINE(1301)
							::openfl::_internal::renderer::DrawCommandBuffer tmp56 = c->buffer;		HX_STACK_VAR(tmp56,"tmp56");
							...
							Float tmp79 = tmp76->f->__get(tmp78);		HX_STACK_VAR(tmp79,"tmp79");
							HX_STACK_LINE(1301)
							tmp55->drawRoundRect(tmp59,tmp63,tmp67,tmp71,tmp75,tmp79);
						}
						;break;
						case (int)10: {
							HX_STACK_LINE(1305)
						...
						case (int)11: {
							...
							Dynamic tmp49 = tmp46->o->__GetItem(tmp48);		HX_STACK_VAR(tmp49,"tmp49");
							HX_STACK_LINE(1311)
							::openfl::display::TriangleCulling tmp50 = ((::openfl::display::TriangleCulling)(tmp49));		HX_STACK_VAR(tmp50,"tmp50");
							HX_STACK_LINE(1311)
							::openfl::_internal::renderer::DrawCommandBuffer tmp51 = c->buffer;		HX_STACK_VAR(tmp51,"tmp51");
							HX_STACK_LINE(1311)
							int tmp52 = c->oPos;		HX_STACK_VAR(tmp52,"tmp52");
							...
							Dynamic tmp54 = tmp51->o->__GetItem(tmp53);		HX_STACK_VAR(tmp54,"tmp54");
							HX_STACK_LINE(1311)
							Array< int > tmp55 = ((Array< int >)(tmp54));		HX_STACK_VAR(tmp55,"tmp55");
							HX_STACK_LINE(1311)
							::openfl::_internal::renderer::DrawCommandBuffer tmp56 = c->buffer;		HX_STACK_VAR(tmp56,"tmp56");
							HX_STACK_LINE(1311)
							int tmp57 = c->iPos;		HX_STACK_VAR(tmp57,"tmp57");
							...
							int tmp59 = tmp56->i->__get(tmp58);		HX_STACK_VAR(tmp59,"tmp59");
							HX_STACK_LINE(1311)
							tmp30->drawTriangles(tmp35,tmp40,tmp45,tmp50,tmp55,tmp59);
						}
						;break;
						default: {
							HX_STACK_LINE(1315)
...
{
		HX_STACK_FRAME("openfl._internal.renderer.cairo.CairoGraphics","renderMask",0x2ed81fde,"openfl._internal.renderer.cairo.CairoGraphics.renderMask","openfl/_internal/renderer/cairo/CairoGraphics.hx",1346,0x744ae94c)
		HX_STACK_ARG(graphics,"graphics")
		HX_STACK_ARG(renderSession,"renderSession")
		HX_STACK_LINE(1348)
		int tmp = graphics->__commands->get_length();		HX_STACK_VAR(tmp,"tmp");
