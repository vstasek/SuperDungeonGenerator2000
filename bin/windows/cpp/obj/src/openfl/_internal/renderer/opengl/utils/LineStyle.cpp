...
{
HX_STACK_FRAME("openfl._internal.renderer.opengl.utils.LineStyle","new",0x3c350e8e,"openfl._internal.renderer.opengl.utils.LineStyle.new","openfl/_internal/renderer/opengl/utils/DrawPath.hx",514,0xf0fd7951)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(515)
	this->width = (int)0;
