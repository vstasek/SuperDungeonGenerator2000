...
::openfl::_internal::renderer::DrawCommandReader EndFillView_Impl__obj::_new( ::openfl::_internal::renderer::DrawCommandReader d){
	HX_STACK_FRAME("openfl._internal.renderer._DrawCommandReader.EndFillView_Impl_","_new",0xde898fd4,"openfl._internal.renderer._DrawCommandReader.EndFillView_Impl_._new","openfl/_internal/renderer/DrawCommandReader.hx",386,0xbbdbd1ae)
	HX_STACK_ARG(d,"d")
	HX_STACK_LINE(386)
