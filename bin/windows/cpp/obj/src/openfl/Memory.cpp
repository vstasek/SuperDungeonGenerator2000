...
int Memory_obj::getByte( int addr){
	...
	if ((tmp1)){
		HX_STACK_LINE(29)
		int tmp3 = (addr + (int)1);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(29)
		int tmp4 = tmp3;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(29)
		int tmp5 = ::openfl::Memory_obj::len;		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(29)
	...
	::lime::utils::ByteArray tmp3 = ::openfl::Memory_obj::gcRef;		HX_STACK_VAR(tmp3,"tmp3");
	HX_STACK_LINE(31)
	int tmp4 = tmp3->b->__get(addr);		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(31)
	return tmp4;
}
...
Float Memory_obj::getDouble( int addr){
	...
	if ((tmp1)){
		HX_STACK_LINE(38)
		int tmp3 = (addr + (int)8);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(38)
		int tmp4 = tmp3;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(38)
		int tmp5 = ::openfl::Memory_obj::len;		HX_STACK_VAR(tmp5,"tmp5");
	...
	Float run(){
		...
		{
			HX_STACK_LINE(42)
			::lime::utils::ByteArray tmp4 = ::openfl::Memory_obj::gcRef;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(42)
			Float tmp5 = tmp4->readDouble();		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(42)
			return tmp5;
		}
		return null();
	...
	HX_STACK_LINE(40)
	Float tmp4 = ::openfl::Memory_obj::_setPositionTemporarily(tmp3, Dynamic(new _Function_1_1()));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(40)
	return tmp4;
}
...
Float Memory_obj::getFloat( int addr){
	...
	if ((tmp1)){
		HX_STACK_LINE(51)
		int tmp3 = (addr + (int)4);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(51)
		int tmp4 = tmp3;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(51)
		int tmp5 = ::openfl::Memory_obj::len;		HX_STACK_VAR(tmp5,"tmp5");
	...
	Float run(){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/Memory.hx",53,0x3e66e7be)
		{
			...
			::lime::utils::ByteArray tmp4 = ::openfl::Memory_obj::gcRef;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(55)
			Float tmp5 = tmp4->readFloat();		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(55)
			return tmp5;
		}
		return null();
...
int Memory_obj::getI32( int addr){
	...
	int run(){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/Memory.hx",66,0x3e66e7be)
		{
			...
			::lime::utils::ByteArray tmp4 = ::openfl::Memory_obj::gcRef;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(68)
			int tmp5 = tmp4->readInt();		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(68)
			return tmp5;
		}
		return null();
	...
	HX_STACK_LINE(66)
	int tmp4 = ::openfl::Memory_obj::_setPositionTemporarily(tmp3, Dynamic(new _Function_1_1()));		HX_STACK_VAR(tmp4,"tmp4");
	HX_STACK_LINE(66)
	return tmp4;
}
...
int Memory_obj::getUI16( int addr){
	...
	if ((tmp1)){
		HX_STACK_LINE(77)
		int tmp3 = (addr + (int)2);		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(77)
		int tmp4 = tmp3;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(77)
		int tmp5 = ::openfl::Memory_obj::len;		HX_STACK_VAR(tmp5,"tmp5");
	...
	int run(){
		HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","openfl/Memory.hx",79,0x3e66e7be)
		{
			...
			::lime::utils::ByteArray tmp4 = ::openfl::Memory_obj::gcRef;		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(81)
			int tmp5 = tmp4->readUnsignedShort();		HX_STACK_VAR(tmp5,"tmp5");
			HX_STACK_LINE(81)
			return tmp5;
		}
		return null();
...
{
		HX_STACK_FRAME("openfl.Memory","setByte",0xca227c9b,"openfl.Memory.setByte","openfl/Memory.hx",96,0x3e66e7be)
		HX_STACK_ARG(addr,"addr")
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(98)
		bool tmp = (addr < (int)0);		HX_STACK_VAR(tmp,"tmp");
...
Void Memory_obj::setDouble( int addr,Float v){
{
		...
		HX_STACK_LINE(109)
		::openfl::Memory_obj::_setPositionTemporarily(tmp3, Dynamic(new _Function_1_1(v)));
	}
return null();
}
