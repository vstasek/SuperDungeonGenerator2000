...
bool ColorTransform_obj::__isDefault( ){
	HX_STACK_FRAME("openfl.geom.ColorTransform","__isDefault",0x071aee26,"openfl.geom.ColorTransform.__isDefault","openfl/geom/ColorTransform.hx",210,0x850de941)
	HX_STACK_THIS(this)
	HX_STACK_LINE(211)
	Float tmp = this->redMultiplier;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(211)
...
int ColorTransform_obj::get_color( ){
	HX_STACK_FRAME("openfl.geom.ColorTransform","get_color",0x07485b49,"openfl.geom.ColorTransform.get_color","openfl/geom/ColorTransform.hx",220,0x850de941)
	HX_STACK_THIS(this)
	HX_STACK_LINE(222)
...
int ColorTransform_obj::set_color( int value){
	HX_STACK_FRAME("openfl.geom.ColorTransform","set_color",0xea994755,"openfl.geom.ColorTransform.set_color","openfl/geom/ColorTransform.hx",227,0x850de941)
	HX_STACK_THIS(this)
...
::lime::utils::ArrayBufferView ColorTransform_obj::__toLimeColorMatrix( ){
	HX_STACK_FRAME("openfl.geom.ColorTransform","__toLimeColorMatrix",0x55c98ae3,"openfl.geom.ColorTransform.__toLimeColorMatrix","openfl/geom/ColorTransform.hx",242,0x850de941)
	HX_STACK_THIS(this)
	HX_STACK_LINE(244)
