...
::lime::_system::_ThreadPool::ThreadPoolMessageType_obj::__register();
::lime::_system::SensorType_obj::__register();
::lime::_system::Endian_obj::__register();
::lime::net::URLLoaderDataFormat_obj::__register();
...
::openfl::_internal::renderer::GraphicsPaths_obj::__register();
...
::lime::_system::System_obj::__register();
::lime::_system::Sensor_obj::__register();
::lime::_system::Clipboard_obj::__register();
::lime::_system::_CFFIPointer::CFFIPointer_Impl__obj::__register();
::lime::_system::CFFI_obj::__register();
::sys::io::_Process::Stdout_obj::__register();
::sys::io::_Process::Stdin_obj::__register();
::sys::io::Process_obj::__register();
::lime::_system::BackgroundWorker_obj::__register();
...
::openfl::display::GLShaderParameter_obj::__register();
...
::openfl::_internal::renderer::opengl::utils::RenderTexture_obj::__register();
::openfl::_internal::renderer::opengl::utils::PingPongTexture_obj::__register();
...
::openfl::_internal::renderer::PolyK_obj::__register();
...
::openfl::_internal::renderer::_DrawCommandReader::DrawTilesView_Impl__obj::__register();
...
::openfl::_internal::renderer::_DrawCommandReader::DrawPathView_Impl__obj::__register();
...
::lime::_system::_ThreadPool::ThreadPoolMessage_obj::__register();
::lime::_system::ThreadPool_obj::__register();
::lime::_system::DisplayMode_obj::__register();
::lime::_system::Display_obj::__register();
::lime::net::URLVariables_obj::__register();
::lime::net::URLRequestHeader_obj::__register();
::lime::net::URLRequest_obj::__register();
::lime::net::URLLoader_obj::__register();
...
::lime::app::Event_lime_net_URLLoader_Void_obj::__register();
::lime::app::Event_lime_net_URLLoader_String_Void_obj::__register();
::lime::app::Event_lime_net_URLLoader_Int_Void_obj::__register();
::lime::app::Event_lime_net_URLLoader_Int_Int_Void_obj::__register();
...
::lime::_system::_ThreadPool::ThreadPoolMessageType_obj::__boot();
::lime::_system::SensorType_obj::__boot();
::lime::_system::Endian_obj::__boot();
::lime::net::URLLoaderDataFormat_obj::__boot();
...
::lime::_system::BackgroundWorker_obj::__boot();
::sys::io::Process_obj::__boot();
::sys::io::_Process::Stdin_obj::__boot();
::sys::io::_Process::Stdout_obj::__boot();
::lime::_system::CFFI_obj::__boot();
::lime::_system::_CFFIPointer::CFFIPointer_Impl__obj::__boot();
::lime::_system::Clipboard_obj::__boot();
::lime::_system::Sensor_obj::__boot();
::lime::_system::System_obj::__boot();
...
::openfl::_internal::renderer::GraphicsPaths_obj::__boot();
