...
class GraphicType_obj : public hx::EnumBase_obj
{
	...
	public:
		...
		static ::openfl::_internal::renderer::opengl::utils::GraphicType DrawTiles(::openfl::display::Tilesheet sheet,Array< Float > tileData,bool smooth,int flags,::openfl::display::Shader shader,int count);
