...
class HXCPP_CLASS_ATTRIBUTES  SpriteBatch_obj : public hx::Object{
	...
	public:
		...
		virtual Void renderBitmapData( ::openfl::display::BitmapData bitmapData,bool smoothing,::openfl::geom::Matrix matrix,::openfl::geom::ColorTransform ct,Dynamic alpha,::openfl::display::BlendMode blendMode,::openfl::display::Shader flashShader,::openfl::display::PixelSnapping pixelSnapping,hx::Null< bool >  bgra);
		Dynamic renderBitmapData_dyn();

		virtual Void renderTiles( ::openfl::display::DisplayObject object,::openfl::display::Tilesheet sheet,Array< Float > tileData,hx::Null< bool >  smooth,hx::Null< int >  flags,::openfl::display::Shader flashShader,hx::Null< int >  count);
		Dynamic renderTiles_dyn();

		virtual Void fillVertices( int index,Float width,Float height,::openfl::geom::Matrix matrix,::openfl::display::TextureUvs uvs,hx::Null< int >  color,::openfl::display::PixelSnapping pixelSnapping);
		...
		virtual Void setState( int index,::lime::graphics::opengl::GLTexture texture,Dynamic smooth,::openfl::display::BlendMode blendMode,::openfl::geom::ColorTransform colorTransform,::openfl::display::Shader shader,Dynamic skipAlpha);
		Dynamic setState_dyn();

		virtual Void setContext( ::lime::graphics::GLRenderContext gl);
		Dynamic setContext_dyn();

		virtual Void prepareShader( ::openfl::display::Shader flashShader,::openfl::display::BitmapData bd);
