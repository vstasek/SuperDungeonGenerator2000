...
class HXCPP_CLASS_ATTRIBUTES  BitmapData_obj : public hx::Object{
	...
	public:
		...
		static ::openfl::display::BitmapData __asRenderTexture( Dynamic width,Dynamic height);
		static Dynamic __asRenderTexture_dyn();
		...
		::openfl::display::Shader __shader;
		::lime::graphics::opengl::GLBuffer __buffer;
		bool __isValid;
		Dynamic __surface;
		::lime::graphics::opengl::GLTexture __texture;
		::lime::graphics::Image __textureImage;
		::openfl::_internal::renderer::opengl::utils::PingPongTexture __pingPongTexture;
		bool __usingPingPongTexture;
		...
		virtual Void __createUVs( hx::Null< Float >  x0,hx::Null< Float >  y0,hx::Null< Float >  x1,hx::Null< Float >  y1,hx::Null< Float >  x2,hx::Null< Float >  y2,hx::Null< Float >  x3,hx::Null< Float >  y3);
		Dynamic __createUVs_dyn();

		virtual Void __drawGL( ::openfl::_internal::renderer::RenderSession renderSession,::openfl::display::IBitmapDrawable source,::openfl::geom::Matrix matrix,::openfl::geom::ColorTransform colorTransform,::openfl::display::BlendMode blendMode,::openfl::geom::Rectangle clipRect,Dynamic smoothing,Dynamic drawSelf,Dynamic clearBuffer,Dynamic readPixels,Dynamic powerOfTwo);
