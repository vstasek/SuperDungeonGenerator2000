...
class HXCPP_CLASS_ATTRIBUTES  DisplayObject_obj : public ::openfl::events::EventDispatcher_obj{
	...
	public:
		...
		static bool __cacheAsBitmapMode;
		::openfl::display::BlendMode blendMode;
		::openfl::geom::Rectangle cacheAsBitmapBounds;
		...
		bool __cacheAsBitmapSmooth;
		bool __forceCacheAsBitmap;
		bool __updateCachedBitmap;
		::openfl::display::BitmapData __cachedBitmap;
		::openfl::geom::Rectangle __cachedBitmapBounds;
		::openfl::geom::Rectangle __cachedFilterBounds;
		bool __updateFilters;
		::openfl::geom::Matrix __cacheGLMatrix;
		...
		virtual Void __cacheGL( ::openfl::_internal::renderer::RenderSession renderSession);
		Dynamic __cacheGL_dyn();
		...
		virtual Void __updateTransforms( ::openfl::geom::Matrix overrideTransfrom);
		...
		virtual ::openfl::display::Shader set_shader( ::openfl::display::Shader value);
		...
		virtual bool get_cacheAsBitmapSmooth( );
		Dynamic get_cacheAsBitmapSmooth_dyn();

		virtual bool set_cacheAsBitmapSmooth( bool value);
		Dynamic set_cacheAsBitmapSmooth_dyn();
