...
class HXCPP_CLASS_ATTRIBUTES  Graphics_obj : public hx::Object{
	...
	public:
		...
		bool __visible;
		::openfl::_internal::renderer::opengl::utils::RenderTexture __cachedTexture;
		...
		virtual Void drawTiles( ::openfl::display::Tilesheet sheet,Array< Float > tileData,hx::Null< bool >  smooth,hx::Null< int >  flags,::openfl::display::Shader shader,hx::Null< int >  count);
